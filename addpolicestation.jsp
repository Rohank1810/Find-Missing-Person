     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <a class="navbar-brand" style="text-transform: uppercase;" style="color:rgb(90 16 91 / 94%)" href="admin.jsp">Find Missing Person</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
              <div class="sidebar-nav navbar-collapse">
                  <ul class="nav" id="side-menu">
                      ...
                      <li>
                          <a href="#"><i class="fa fa-sitemap fa-fw nav_icon"></i>View Missing Person Complaints<span class="fa arrow"></span></a>
                          <ul class="nav nav-second-level">
                              <li>
	   ...
	   <div class="xs">
  	    ...
  	    <div class="well1 white">
  	     <h2 style=" color: black; text-transform: uppercase;">Add police Station</h2>
        <form action ="policesignup" class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" novalidate="novalidate" ng-submit="submit()">
          <fieldset>
            ...
            <div class="form-group">
              <label class="control-label">Police Station Password</label>
            ...
            <div class="form-group">
              <label class="control-label">Police Station Email</label>
